---
title: "Simular Tempo de Digitação"
---
...
> 🖼️ **[IMAGEM PENDENTE]** — reenviar do GitBook (ref. `jdEkdZqZpNvLigoNSke1`)
...
> 🖼️ **[IMAGEM PENDENTE]** — reenviar do GitBook (ref. `Dec6haCDSeRrd0n8wBtO`)
