...
1. No menu lateral esquerdo, selecione a opção **Formas de pagamento**.
2. No painel central, localize a seção **"Adicionar forma de pagamento da empresa"** e clique no botão **Adicionar.**
...
Uma janela de configuração será exibida. Preencha os campos com atenção, pois **essas informações não poderão ser alteradas após definidas:**
...
1. Abaixo da seção de cartões, clique na aba **Contas do WhatsApp Business.**
2. Selecione a conta desejada (ex: Wts-Automacao).
3. Clique no botão **Adicionar forma de pagamento** no rodapé da página.
4. Selecione o cartão que você acabou de cadastrar e confirme a vinculação.


![imagem](https://pub-eb092ec0af8f4647afd1a46435d20f24.r2.dev/whatsapp_(oficial)/pagamentos/configurar/image%20(5).avif)
