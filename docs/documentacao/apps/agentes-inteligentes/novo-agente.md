...
* Ter acesso a plataforma com perfil de administrador
...
#### Passo 2: Antes de Criar o Agente: Configurações Essenciais
...
1. Na tela inicial, clique em **"Empresas"** e dentro da seção **“Informações sobre a Empresa”**, clique no botão “Adicionar empresa”.
...
Nesta primeira seção, você define quem é o seu agente:

* **Nome do agente:** O nome interno para sua organização (ex: "Agente de Vendas N1").
...
* **Forma de comunicação:** Escolha o tom de voz (ex: *Consultivo e Acolhedor*, *Neutro e Equilibrado* ou *Formal*).
* **Formato da resposta:** Defina o tamanho ideal das mensagens (ex: *Curta e Objetiva* ou *Longa e Detalhada*).
* **Perfil do agente:** Selecione a função que melhor o descreve (Vendedor, Suporte, Recepcionista, etc.).

**C. Objetivo (Prompt do Sistema)**

No campo **"Descreva o objetivo deste agente"**, você dará as instruções centrais.
