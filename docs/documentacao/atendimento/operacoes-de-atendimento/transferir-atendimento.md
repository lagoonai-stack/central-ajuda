...
| ------------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Para uma equipe** | O atendimento é enviado para a fila de espera da nova equipe, ficando disponível para que qualquer membro a assuma. | O atendimento retorna para a aba “Novos” da equipe de destino. Caso seja a sua equipe, o contador dessa aba será atualizado.                                                     |
...
**Escolha da equipe (ao transferir para outro usuário):**
Se você transferir um atendimento para um usuário que não faz parte da equipe atual, o sistema solicitará que você selecione para qual equipe o atendimento será encaminhado. Caso o usuário de destino pertença a múltiplas equipes, será possível escolher a mais apropriada.
