---
title: "Relação de acessos x conversas"
---
...
> 🖼️ **[IMAGEM PENDENTE]** — reenviar do GitBook (ref. `AquKBEnYty4ZdZRlMCWD`)
...
> 🖼️ **[IMAGEM PENDENTE]** — reenviar do GitBook (ref. `EGKbcAtqLJ6szwBrBREv`)
